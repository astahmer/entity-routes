...
-   [`SearchFilter`](/filters/search-filter), used with the `@Search decorator`, allows you to search using a
    [`StrategyType`](/definitions#strategytype)
-   [`PaginationFilter`](/filters/pagination-filter), used with the `@Pagination decorator`, allows you to paginate and
    order the results
