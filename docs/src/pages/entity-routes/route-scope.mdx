...
[`EntityRouter`](/definitions/classes/entityrouter) set up on the `Article` entity with `["create", "update", "list"]` [**operations**](/entity-routes/operations/), you would have those
routes generated :
