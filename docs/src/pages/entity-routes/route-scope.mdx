...
-   An [operation](/api-reference/introduction#operations), for example any of the [C|R|U|D operations](/api-reference/globals#groupsoperation)

## Inferred Mapping

The **mapping** is a description of every properties exposed through the [`@Groups`](/api-reference/globals#groups) decorator for a specific **route scope**.
...
More on that [later](/api-reference/introduction#groups).
