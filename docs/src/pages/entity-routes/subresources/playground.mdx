---
title: Subresources Playground
description: Experience how you can configure each @Subresource and see the route generation results.
---

import { SubresourcePlayground } from "@/components";
...
<Info>
    You can just click on "Generate all possible routes" and see each possibilities for the config defined above. You
    can also hover on the warning icon to see the reason why the subresource can not be nested further.
</Info>
