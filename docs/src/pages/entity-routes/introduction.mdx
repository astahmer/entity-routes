...
An entity for `entity-router` is nothing more than a TypeORM entity. We only expects you to implement the
[`GenericEntity`](/definitions/interfaces/genericentity) interface on every entities used.
...
can learn more about TypeORM table inheritance [here](https://typeorm.io/#/entity-inheritance).
...
If you don't wan't to write all [**operations**](/entity-routes/operations/) everytime you just need to import & use
[CRUD_OPERATIONS](/definitions#const-crud_operations). It looks like this.
...
Any [`maker`](/entity-routes/introduction#maker/) should wrap the [makeEntityRouters](/definitions#makeentityrouters),
...
There are 2 built-in makers: [`makeKoaEntityRouters`](/definitions/definitions#makekoaentityrouters) &
[`makeExpressEntityRouters`](/definitions/definitions#makeexpressentityrouters).
