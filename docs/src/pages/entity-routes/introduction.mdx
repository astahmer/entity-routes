...
-   [Granular control over which properties are exposed](/entity-routes/groups/definitions) (with [`@Groups`](/definitions#groups)) in which
    route scope
-   [`Subresources`](/entity-routes/subresources): Entity properties that have dedicated endpoints, can be nested
-   Independant service components (Database [`Reader`](/definitions/classes/reader), `Persister`, [`RelationManager`](/definitions/classes/relationmanager) etc...)
