...
([`EntityRouteOptions`](/definitions/definitions#entityrouteoptions)) argument, available when making entity routers
(using [`makeEntityRouters`](/definitions#makeentityrouters)) or directly in the
[`@EntityRoute`](/definitions/definitions#entityroute).
