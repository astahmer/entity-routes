...
you might want to directly access the article list with only the properties you want for that [`route scope`](/entity-routes/route-scope).

By decorating the `articles` property with the [@Subresource](/definitions#subresource) decorator, you generates 3 routes :
...
Of course, you can customize your Subresource using [SubresourceOptions](/definitions#subresourceoptions) as optional second argument.
