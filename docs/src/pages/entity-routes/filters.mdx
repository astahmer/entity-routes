...
A very common need for APIs is to filter a list through different conditions. There are 2 basic filters built-in, both
extending the [`AbstractFilter`](/definitions/classes/abstractfilter) :
...
accordingly or/and by passing an array of property paths.
...
[`StrategyType`](/definitions#strategytype) directly in the request.
