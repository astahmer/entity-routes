...
[**computed properties**](/entity-groups/groups/introduction#computed-property) can't meet your needs), maybe depending
on the metadata, a concrete example of that case are
