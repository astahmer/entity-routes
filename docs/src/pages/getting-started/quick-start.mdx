...
import { DataTable, Collapsable } from "@/components";
...
<Collapsable collapse={{ startingHeight: 230 }} suffix="rows">
    <DataTable
        columns={["Verb", "Path", "Name"]}
        rows={[
...
import _ as Koa from "koa";
import _ as bodyParser from "koa-bodyparser";
