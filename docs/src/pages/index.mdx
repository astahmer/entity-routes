...
## [Instant CRUD from your TypeORM entities](/entity-routes/introduction)
...
## [Granular control over which properties are exposed](/groups/introduction)

With the [`@Groups`](/groups/introduction) decorator you can configure your properties to be exposed in a specific or
...
## [Subresources](/entity-routes/subresources/introduction)

You can have entity properties that have dedicated endpoints using **Subresources** and
[nested Subresources](/entity-routes/subresources/introduction#nesting).
...
## [Auto Route Mappings](/entity-routes/route-scope#inferred-mapping)
...
## [Filters](/filters/introduction)

You can use list [**filters**](/filters/introduction) to alter items returned with auto SQL generated conditions. We
have two built-in powerful [**filters**](/filters/introduction) for lists
([Search](/filters/search-filter)/[Pagination](/filters/pagination-filter)) that should fit well for 99% use cases. But
you can also make your own custom [**filters**](/filters/introduction) if you find yourself in the 1%

## [Hooks](/entity-routes/hooks)

There are [**hooks**](/entity-routes/hooks/) available to intervene at any point in the process of a request handling.

## [Computed properties](/groups/computed-property)
...
[`@DependsOn`](/definitions#dependson) decorator.
